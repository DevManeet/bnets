...
- **Clone PrivateGPT Repository:** Clone the PrivateGPT repository to your machine and navigate to the directory:
  ```sh
  git clone https://github.com/zylon-ai/bnet.git
  cd bnet
  ```
...
**Description:**
This profile runs the Ollama service using CPU resources. It is the standard configuration for running Ollama-based bnet services without GPU acceleration.
...
**Description:**
This profile runs the bnet services locally using `llama-cpp` and Hugging Face models.
