...
from bnet.paths import local_data_path
        ...
        match settings.vectorstore.database:
            ...
            case "chroma":
                try:
                    ...
                    from bnet.components.vector_store.batched_chroma import (
            ...
            case "milvus":
                ...
                if settings.milvus is None:
                    logger.info(
                        ...
                        "Trying to connect to Milvus at local_data/bnet/milvus/milvus_local.db "
