...
from bnet.open_ai.openai_models import (
    OpenAICompletion,
    OpenAIMessage,
)
from bnet.server.chat.chat_router import ChatBody, chat_completion
from bnet.server.utils.auth import authenticated
...
def prompt_completion(
    ...
    "model":"bnet","choices":[{"index":0,"delta":{"content":"Hello"},
    "finish_reason":null}]}
    ```
    """
