...
from bnet.settings.settings_loader import load_active_settings
...
class ServerSettings(BaseModel):
    ...
    port: int = Field(description="Port of Bnet FastAPI server, defaults to 8000")
...
class UISettings(BaseModel):
    ...
    default_risk_management_system_prompt: str = Field(
        None,
        description="The default system prompt to use for the risk management mode.",
    )
    default_legal_system_prompt: str = Field(
        None,
        description="The default system prompt to use for the legal mode.",
    )
...
class MilvusSettings(BaseModel):
    uri: str = Field(
        "local_data/bnet/milvus/milvus_local.db",
        description="The URI of the Milvus instance. For example: 'local_data/bnet/milvus/milvus_local.db' for Milvus Lite.",
    )
    token: str = Field(
        "",
        description=(
